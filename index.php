...
$ini_array = parse_ini_file("logs.ini",true);
...
builder::Header('.logs v. 0.0.1b');
?>

</head>
<body>
    <div class="homeBox">
        <div style="text-align: center;"><br><IMG SRC="images\logo_logs.png" width="350"></div>
            <form method="post" action="" style="width: 80%;margin: 0 auto;text-align: center;">
                ...
                <input type = "submit" name="button" value = " Accedi " class="btn btn-black"  /><BR/><BR>
                <p style="font-size: small;font-weight: bold;color: white">Usare gli stessi dati di accesso del CRM</p>
            </form>
